...
import AuthenticateNavbar from '../../../Components/AuthenticateNavbar';
import { FaEye, FaEyeSlash } from 'react-icons/fa';
import { encryptData } from '../../../Utils/cryptoUtils'; // Adjust the path as necessary
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.post('/authenticate/login', { email, password });
      const { accessToken, refreshToken, userData } = response.data;

      // Encrypt tokens and userData
      ...
      // Store encrypted tokens and userData in local storage
