...
//     .map(date => new Date(date).toISOString().split('T')[0]); // Format dates to YYYY-MM-DD
...
//   const dateStats = filteredDates.map(date => {
//     const presentCount = attendanceData.filter(student => {
//       const index = student.dates.findIndex(d => new Date(d).toISOString().split('T')[0] === date);
//       return index !== -1 && student.lectures[index] === 1;
//     }).length;

//     const percentage = (presentCount / totalStudents) * 100;
//     return { presentCount, totalCount: totalStudents, percentage };
//   });
...
//                   </tr>
//                 ))}
//                 {/* Attendance Statistics Rows */}
//                 <tr>
//                   <td colSpan={2} style={{ backgroundColor: '#f3be49' }}>Attendance Count</td>
//                   {dateStats.map((stat, idx) => (
//                     <td key={idx} style={{ backgroundColor: '#f3be49' }}>
...
//                 </tr>
//                 <tr>
//                   <td colSpan={2} style={{ backgroundColor: '#f3be49' }}>Attendance Percentage</td>
//                   {dateStats.map((stat, idx) => (
//                     <td key={idx} style={{ backgroundColor: '#f3be49' }}>
...
//   const counts = filteredDates.map(date => {
...
//   const percentages = counts.map(count => (studentCount > 0 ? (count / studentCount) * 100 : 0).toFixed(2));
...
//                   </tr>
//                 ))}
//                 {/* Row for count of students present */}
//                 <tr>
//                   <td colSpan={filteredDates.length + 2} style={{ textAlign: 'center', backgroundColor: '#e0e0e0', fontWeight: 'bold' }}>
...
//                   <td></td>
//                 </tr>
//                 {/* Row for percentage of students present */}
//                 <tr>
//                   <td colSpan={filteredDates.length + 2} style={{ textAlign: 'center', backgroundColor: '#e0e0e0', fontWeight: 'bold' }}>
...
//                     <td key={idx} style={{ textAlign: 'center' }}>{percentage}%</td>
//                   ))}
//                   <td></td>
//                 </tr>
//               </tbody>
...
//   const generateCSV = () => {
//     const csvContent = [
//       ["Student PRN", "Name", ...filteredDates.map((date, idx) => `Lec ${idx + 1} - ${formatDate(date)}`), "Percentage", "Signature"], // Headers with Lecture Numbers
//       ...filteredAttendance.map(student => [
//         student.prn,
//         student.name,
//         ...cumulativeAttendance(student.lectures, filteredDates),
